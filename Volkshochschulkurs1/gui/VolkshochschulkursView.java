...
public class VolkshochschulkursView {
    ...
    public VolkshochschulkursView(Stage primaryStage, VolkshochschulkursControl control){
    ...
    private void initListener(VolkshochschulkursControl control) {
    	
    	btnEingabe.setOnAction(new EventHandler<ActionEvent>() { 
    	
    	@Override
         	 public void handle(ActionEvent e) {
             	control.nehmeKurseAuf(txtName.getText(), txtWochentag.getText(), txtStartuhrzeit.getText(), txtKursbeitrag.getText(), txtVorkenntnisse.getText());
             }
 	    });
 	   ...
 	   mnItmCsvExport.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent e) {
         	   control.schreibeVolkshochschulkursInDatei("csv");
            }
 	   });
